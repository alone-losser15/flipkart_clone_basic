...
// }
function expand1(){
    document.getElementById("main_img").innerHTML='<img src="../img/img78.jpg" ondblclick="expand()">'
}
function expand2(){
    document.getElementById("main_img").innerHTML='<img src="../img/img79.jpg" ondblclick="expand()">'
}
function expand3(){
    document.getElementById("main_img").innerHTML='<img src="../img/img80.jpg" ondblclick="expand()">'
}
// function expand4(){
...
function addcart(){
    ...
    localStorage.setItem("Product_Details16",Product_Details);
    localStorage.setItem("Product_Img16",Product_Img);
}
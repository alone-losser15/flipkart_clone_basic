...
// }
function expand1(){
    document.getElementById("main_img").innerHTML='<img src="../img/img66.jpg" ondblclick="expand()">'
}
function expand2(){
    document.getElementById("main_img").innerHTML='<img src="../img/img67.jpg" ondblclick="expand()">'
}
function expand3(){
    document.getElementById("main_img").innerHTML='<img src="../img/img68.jpg" ondblclick="expand()">'
}
// function expand4(){
...
function addcart(){
    ...
    localStorage.setItem("Product_Details11",Product_Details);
    localStorage.setItem("Product_Img11",Product_Img);
}
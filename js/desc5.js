...
//}
function expand1(){
    document.getElementById("main_img").innerHTML='<img src="../img/img43.jpg" ondblclick="expand()">'
}
function expand2(){
    document.getElementById("main_img").innerHTML='<img src="../img/img44.jpg" ondblclick="expand()">'
}
function expand3(){
    document.getElementById("main_img").innerHTML='<img src="../img/img45.jpg" ondblclick="expand()">'
}
// function expand4(){
...
function addcart(){
    ...
    localStorage.setItem("Product_Details5",Product_Details);
    localStorage.setItem("Product_Img5",Product_Img);
}

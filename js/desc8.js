...
//}
function expand1(){
    document.getElementById("main_img").innerHTML='<img src="../img/img53.jpg" ondblclick="expand()">'
}
function expand2(){
    document.getElementById("main_img").innerHTML='<img src="../img/img54.jpg" ondblclick="expand()">'
}
function expand3(){
    document.getElementById("main_img").innerHTML='<img src="../img/img55.jpg" ondblclick="expand()">'
}
// function expand4(){
...
function addcart(){
    ...
    localStorage.setItem("Product_Details8",Product_Details);
    localStorage.setItem("Product_Img8",Product_Img);
}